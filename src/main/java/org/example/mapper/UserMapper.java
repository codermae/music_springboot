...
public interface UserMapper {   //定义了一个名为 UserMapper 的公共接口。
    ...
    //  创建用户
    @Insert("INSERT INTO users (username, password_hash, privilege,mobile, regist_date, update_date) VALUES (#{username}, #{password_hash}, #{privilege},#{mobile}, #{regist_date}, #{update_date})")
